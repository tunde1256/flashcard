...
router.post("/createflashcard/:userId", userController.createQuestionAndAnswer2); // Create question and answer together
...
router.delete('/categories/:categoryName/:userId', userController.deleteCategories);
